...
# -r 10 por 3 s: o `--once` sai antes de a assinatura casar e a mensagem se perde.
timeout 3 ros2 topic pub -r 10 /wheel_vel_setpoints wheel_msgs/msg/WheelSpeeds \
...
touch "$d/fim"
wait "$MEGA"; echo "   MEGA fingida saiu com codigo $?"
