...
Os números medidos aqui vão para
`ros2_packages/robot_motion/config/teleop_xbox.yaml`. Portado do robô 1
(commit ecd6e70) sem mudança: o protocolo do joydev é do kernel, não do robô.
Lá o Xbox Series mediu LB=6 e RB=7 por Bluetooth — é o que o YAML traz hoje, e
é o que ESTE controle tem de confirmar antes de alguém confiar nele.
"""
