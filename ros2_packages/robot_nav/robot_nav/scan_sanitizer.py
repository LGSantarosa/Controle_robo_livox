...
fincavam o robô (ver comentário no yaml). SLAM segue no /scan cru — já tem
range_min próprio e usa o scan pra geometria.
...
def main(args=None):  # pragma: no cover - cola de I/O, validar na bancada
    ...
    class ScanSanitizer(Node):
        ...
        def _on_scan(self, msg: LaserScan):
            ...
            # Sem fantasma: repassa a msg como veio (zero cópia).
