# Funções comuns do bin/valida-etapa5 — CÓPIA da lib da etapa 4
# (tools/valida_etapa4/lib.sh, evidência congelada; não refatorada de
# propósito). Etapa 5, docs/PLANO_ETAPA5_ROBO3.md §3.3. Carregado com
