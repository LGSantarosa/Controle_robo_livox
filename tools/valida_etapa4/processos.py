...
Etapa 4, passo 7 (§10.5). Identidade de processo = (pid, starttime): PID e
PGID sozinhos podem ser reusados. A marca é VALIDA_ETAPA4_MARCA=<pasta desta
rodada>, herdada por todo processo que o wrapper lança.
...
def compara(antes, depois, grupos, externos, agora_ticks_antes):
    ...
    itens = {
        ...
        'externos_estavam_vivos_antes': all(e['antes'] for e in ext) and bool(ext),
        'externos_vivos_depois_mesmo_starttime': (
            all(e['vivo_depois'] for e in ext) and bool(ext)),
    }
    return {
