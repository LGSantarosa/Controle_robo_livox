...
🔁 Recopiado SEM MUDANÇA para a etapa 6 (docs/PLANO_ETAPA6_ROBO3.md §4.8), que
precisa da mesma coisa com um alvo novo: além dos nós da pilha, o Gazebo. Vale
para ele o que vale para o resto — sinal só com identidade reconferida, e nunca
`pkill -f`, que neste projeto já matou uma sessão ssh.
